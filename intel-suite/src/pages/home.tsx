      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        >
          <div className="inline-flex items-center justify-center mb-5">
            <img src={LOGO_URL} alt="Occu-Med" style={{ width: "320px", height: "auto", objectFit: "contain", display: "block", filter: "invert(1) brightness(1.8) drop-shadow(0 0 24px rgba(255,255,255,0.35))" }} />
          </div>
